...
public class RemoteLoaderTest {
    ...
    public static void main(String[] args) {
        ...
        StereoUpCommand stereoOn = new StereoUpCommand(stereo);
        StereoDownCommand stereoOff = new StereoDownCommand(stereo);
        ...
        remoteControl.setCommands(3,stereoOn,stereoOff);
